...
Card.Link = function CardLink({
  ...
  return (
    <>
      <div className="absolute -inset-x-4 -inset-y-6 z-0 scale-95 bg-stone-50 opacity-0 transition group-hover:scale-100 group-hover:opacity-100 sm:-inset-x-6 sm:rounded-2xl dark:bg-stone-800/50" />
      <Link {...props}>
...
Card.Description = function CardDescription({
  ...
  return (
    <p className="relative z-10 mt-2 flex-1 text-sm text-stone-600 dark:text-stone-400">
      {children}
    </p>
  )
}
